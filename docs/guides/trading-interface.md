...
Binance DEX trading page is designed to provide a user-friendly trading interface to everyone. To get started, go to the trading page first at https://www.bnbchain.world/trade. The trading page is composed of the following part:
...
- Balances: This section displays the current balance of your BNB Beacon Chain Wallet.
