# How to Verify Your Contract on bscscan.com

## Step 1 (Prereq): Your contract is already deployed on BNB Smart Chain
For reference on how to deploy your contract on BNB Smart Chain using different environments, refer to the [Deploy Section](https://docs.bnbchain.world/smart-chain/developer/deploy/remix.html).
