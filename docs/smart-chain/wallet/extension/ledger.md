...
2. Select and open the Ethereum Application. If you haven't installed Ethereum Application, please read this[ guide](https://docs.bnbchain.world/smart-chain/wallet/ledger.html#app-installation-instructions)
...
4. Open BNB Beacon Chain Extension Wallet and select "BNB Smart Chain" network
...
!!! Warning
       Please note you cannot use Ledger account for BNB Beacon Chain network. 
