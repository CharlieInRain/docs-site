# Use BNB Beacon Chain Extension Wallet
## What is it?
BNB Beacon Chain Extension Wallet is a Crypto Wallet for BNB Beacon Chain, BNB Smart Chain. You can send and receive funds on BNB Beacon Chain, BNB Smart Chain and cross-chain transfers between both of Binance’s blockchains.

In the future, BNB Beacon Chain Extension Wallet will add support for Ethereum blockchain and enable access for distributed applications, or "Dapps" in your browser!
...
[How to manually install the BNB Beacon Chain Extension Wallet](manual.md)


## Install

**Example: Install BNB Beacon Chain Wallet in Firefox browser**

* Open Extension in Firefox: <https://addons.mozilla.org/en-US/firefox/addon/binance-chain/?src=search>

* Search for BNB Beacon Chain
...
Note: Make sure it’s offered by BNB Beacon Chain
...
That’s it! You have successfully installed the BNB Beacon Chain Wallet extension in Firefox!
...
* Install BNB Beacon Chain extension by following the previous steps
...
* Go to <https://testnet.bnbchain.world/faucet-smart/>
...
* Follow the instructions above to Install BNB Beacon Chain extension wallet if not ready
