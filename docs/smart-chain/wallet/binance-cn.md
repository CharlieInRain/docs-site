...
* 打开以下页面 <https://testnet.bnbchain.world/faucet-smart/>
...
* 打开钱包后，切换到BNB Beacon Chain Testnet。复制地址，以 `tbnb1`开头
...
* 切换到BNB Beacon Chain Testnet，确认转账完成
...
* 切换到BNB Beacon Chain Testnet，点击 “Send”
...
* 切换到BNB Beacon Chain Testnet。复制地址，以 `tbnb1`开头
...
* 切换到BNB Beacon Chain Testnet，确认收到BEP2代币
